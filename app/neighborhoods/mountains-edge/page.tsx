...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Mountains Edge offers the largest park in the Las Vegas Valley—the 120-acre Exploration Peak Park with stunning views—plus master-planned amenities at prices below Summerlin or Henderson. It fits buyers seeking value without sacrificing lifestyle.",
      },
    },
    {
      "@type": "Question",
...
export default function MountainsEdgePage() {
  return (
    <>
      ...
      />
      <RoutePageHero path="/neighborhoods/mountains-edge" />
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  ...
                  below Summerlin or Henderson. It fits buyers seeking value without
